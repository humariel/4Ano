...
//few helping functions were added
...
function euclideanDist(a, b){
    var squaresSum = Math.pow(a[0] - b[0], 2) + Math.pow(a[1] - b[1], 2) + Math.pow(a[2] - b[2], 2);
    return Math.sqrt( squaresSum );
}

function illumCoeficient(min, max, dist){
    var divs = (max-min);
    return (max-dist) * (1/divs);
}
