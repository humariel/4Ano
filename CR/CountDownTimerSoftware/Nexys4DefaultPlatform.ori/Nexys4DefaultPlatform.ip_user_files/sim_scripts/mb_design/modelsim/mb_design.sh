...
#
# Generated by Vivado on Sun Apr 19 18:05:13 WEST 2020
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/gabriel/UA/4Ano/CR/CountDownTimerSoftware/Nexys4DefaultPlatform.ori/Nexys4DefaultPlatform.cache/compile_simlib/modelsim"
  fi
